...
app.add_url_rule(
    "/vm/check_ssh", "check_ssh_all_vms", api.check_ssh_all_vms, methods=["GET"]
)
app.add_url_rule(
    "/vm/check_ssh/<string:vm_name>", "check_ssh_vm", api.check_ssh_vm, methods=["POST"]
)
...
app.add_url_rule(
    "/flags/submissions",
    "get_flags_submissions",
    api.get_flags_submissions,
    methods=["GET"],
)
